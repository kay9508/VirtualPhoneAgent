...
public class Hex {
     ...
     * byte. An com.sinyoung.exception is thrown if the passed char array has an odd number of elements.
     *
     ...
     * to represent any given byte. An com.sinyoung.exception is thrown if the passed char array has an odd number of elements.
     *
